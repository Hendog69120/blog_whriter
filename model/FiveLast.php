...
class LastManager
{
    ...
    public function getFiveLast()
    {
        ...
        $req = $this->db->query('SELECT id, title, content, DATE_FORMAT(creation_date, \'%d/%m/%Y à %Hh%imin%ss\') AS date_creation_fr FROM post ORDER BY creation_date DESC LIMIT 0, 5');
